...
def regresion_lineal_multiple(X_train, y_train, X_test):
    ...
    n_train = X_train.shape[0] # Número de filas (observaciones)
    X_train_b = np.hstack([np.ones((n_train, 1)), X_train]) # Esto introduce el intercepto en el modelo
    ...
    y_pred = X_test_b @ coefs # Producto matricial
